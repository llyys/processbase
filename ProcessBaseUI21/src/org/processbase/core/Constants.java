...
public class Constants {
    ...
    public static void loadConstants() {
        try {
            ...
            properties.storeToXML(new FileOutputStream(new File("test.properties")), "test");
            
            File file = new File("processbase2.properties");
            FileInputStream fis = new FileInputStream(file);
            System.out.println("processbase2.properties length = " + file.length());
            ...
            BONITA_EJB_ENV.put("org.ow2.bonita.api-type", "Standard");
