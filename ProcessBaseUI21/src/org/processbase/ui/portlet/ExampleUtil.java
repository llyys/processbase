...
public final class ExampleUtil {
    ...
    private static void fillIso3166Container(IndexedContainer container) {
        ...
        container.addContainerProperty("name4", String.class, null);
        container.addContainerProperty("name5", String.class, null);
        container.addContainerProperty("name6", String.class, null);
        container.addContainerProperty("name7", String.class, null);
        container.addContainerProperty("name8", String.class, null);
        container.addContainerProperty("name9", String.class, null);
        ...
        for (int i = 0; i < iso3166.length; i++) {
            ...
            item.getItemProperty("name2").setValue(name);
            item.getItemProperty("name3").setValue(name);
            item.getItemProperty("name4").setValue(name);
            item.getItemProperty("name5").setValue(name);
            item.getItemProperty("name6").setValue(name);
            item.getItemProperty("name7").setValue(name);
            item.getItemProperty("name8").setValue(name);
            item.getItemProperty("name9").setValue(name);
