...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            configuration = new Configuration().setProperty("hibernate.dialect", BAMConstants.BAM_DB_DIALECT)
                                        .setProperty("hibernate.dialect", "org.hibernate.dialect.Oracle10gDialect")
                                        .setProperty("hibernate.connection.datasource", BAMConstants.BAM_DB_POOLNAME)
                    //
...
//                    .setProperty("hibernate.connection.password", "pbbam2")
                    ...
                    .addClass(org.processbase.util.bam.metadata.MetaDim.class)
                    .addClass(org.processbase.util.bam.metadata.MetaFact.class)
                    .addClass(org.processbase.util.bam.metadata.MetaKpi.class);
