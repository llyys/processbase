                ...
                if (getStepState(step.getName()) != null) {
                    ...
                    if (step.getType().equals("process:Task") || step.getType().equals("process:Activity")) {
                        processImage.createGraphics().drawImage(ind,
                                ...
                                step.getY() + process.getY() + step.getHeight() - ind.getHeight() - 2,
                                null);
                    } else {
                        processImage.createGraphics().drawImage(ind,
...
//                        System.out.println("      step " + stepNode.getAttributes().getNamedItem("name").getNodeValue() + "      " + stepNode.getAttributes().getNamedItem("xmi:id").getNodeValue());
