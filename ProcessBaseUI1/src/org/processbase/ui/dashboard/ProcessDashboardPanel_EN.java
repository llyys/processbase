 ...
 * @author mgubaidullin
 */
public class ProcessDashboardPanel_EN extends AnalyticPanel {

    public ProcessDashboardPanel_EN() {
        super();
    }
    ...
    public void refreshDashboard() {
        try {
            ...
            values.add(new BarValue(bpmModule.getProcessInstancesByStatus(InstanceState.INITIAL).size(), "Init", ""));
            values.add(new BarValue(bpmModule.getProcessInstancesByStatus(InstanceState.CANCELLED).size(), "Canceled", ""));
            values.add(new BarValue(bpmModule.getProcessInstancesByStatus(InstanceState.FINISHED).size(), "Finished", ""));
            values.add(new BarValue(bpmModule.getProcessInstancesByStatus(InstanceState.ABORTED).size(), "Rejected", ""));
            values.add(new BarValue(bpmModule.getProcessInstancesByStatus(InstanceState.STARTED).size(), "Ecexuted", ""));
