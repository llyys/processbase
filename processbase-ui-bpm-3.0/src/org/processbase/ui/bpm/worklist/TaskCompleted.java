...
import org.processbase.ui.core.util.ProcessAndTaskDefinition;
import org.processbase.ui.bpm.generator.GeneratedWindow;
import org.processbase.ui.bpm.worklist.TaskCompleted.TaskAndProcess;
...
public class TaskCompleted extends TreeTablePanel {
    ...
    public void initUI() {
        ...
        treeTable.addContainerProperty("taskName", TableLinkButton.class, null, ProcessbaseApplication.getCurrent().getPbMessages().getString("tableCaptionTask"), null, null);
