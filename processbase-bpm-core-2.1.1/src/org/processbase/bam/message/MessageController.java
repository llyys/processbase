...
//        marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
    ...
    public static void sendKpiToMQ(Kpi kpi) throws JMSException, NamingException {
        ...
        try {
            ...
            QueueConnectionFactory queueConnectionFactory = (QueueConnectionFactory) ctx.lookup(Constants.BAM_MQ_CONNECTION_FACTORY);
            Queue jmsQueue = (Queue) ctx.lookup(Constants.BAM_MQ_DESTINATION_RESOURCE);
...
//            session.commit();
    ...
    public static Connection newConnection() {
        ...
        try {
            ...
            DataSource ds = (DataSource) context.lookup(Constants.BAM_DB_POOLNAME);
