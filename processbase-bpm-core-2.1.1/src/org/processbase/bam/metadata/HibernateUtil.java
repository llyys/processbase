...
import org.processbase.bam.message.DimensionType;
import org.processbase.bam.message.FactType;
import org.processbase.bam.message.Kpi;
...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            configuration = new Configuration().setProperty("hibernate.dialect", Constants.BAM_DB_DIALECT)
...
//                                        .setProperty("hibernate.connection.datasource", Constants.BAM_DB_POOLNAME)
                    ...
                    .addClass(org.processbase.bam.metadata.MetaDim.class)
                    .addClass(org.processbase.bam.metadata.MetaFact.class)
                    .addClass(org.processbase.bam.metadata.MetaKpi.class);
