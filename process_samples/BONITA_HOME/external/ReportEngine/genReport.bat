...
SET BIRTCLASSPATH=%BIRT_HOME%\ReportEngine\lib\chartengineapi.jar;%BIRT_HOME%\ReportEngine\lib\chartitemapi.jar;%BIRT_HOME%\ReportEngine\lib\com.ibm.icu_4.0.1.v20090822.jar;%BIRT_HOME%\ReportEngine\lib\commons-cli-1.0.jar;%BIRT_HOME%\ReportEngine\lib\coreapi.jar;%BIRT_HOME%\ReportEngine\lib\crosstabcoreapi.jar;%BIRT_HOME%\ReportEngine\lib\dataadapterapi.jar;%BIRT_HOME%\ReportEngine\lib\dataaggregationapi.jar;%BIRT_HOME%\ReportEngine\lib\dataextraction.jar;%BIRT_HOME%\ReportEngine\lib\dteapi.jar;%BIRT_HOME%\ReportEngine\lib\emitterconfig.jar;%BIRT_HOME%\ReportEngine\lib\engineapi.jar;%BIRT_HOME%\ReportEngine\lib\flute.jar;%BIRT_HOME%\ReportEngine\lib\js.jar;%BIRT_HOME%\ReportEngine\lib\modelapi.jar;%BIRT_HOME%\ReportEngine\lib\modelodaapi.jar;%BIRT_HOME%\ReportEngine\lib\odadesignapi.jar;%BIRT_HOME%\ReportEngine\lib\org.apache.commons.codec_1.3.0.v20080530-1600.jar;%BIRT_HOME%\ReportEngine\lib\org.eclipse.emf.common_2.5.0.v200906151043.jar;%BIRT_HOME%\ReportEngine\lib\org.eclipse.emf.ecore_2.5.0.v200906151043.jar;%BIRT_HOME%\ReportEngine\lib\org.eclipse.emf.ecore.xmi_2.5.0.v200906151043.jar;%BIRT_HOME%\ReportEngine\lib\org.w3c.css.sac_1.3.0.v200805290154.jar;%BIRT_HOME%\ReportEngine\lib\scriptapi.jar;
