...
public class AttachmentsPanel extends TablePanel
    ...
    public AttachmentsPanel(String processUUID, String[] fileTypes, boolean add, boolean delete, boolean edit) {
        super();
...
//            buttonBar.addComponent(upload);
        ...
        docUtil = new DocumentLibraryUtil();
        initTableUI();
    }
    ...
    public void initTableUI() {
        ...
        table.addContainerProperty("type", Component.class, null, PbPortlet.getCurrent().messages.getString("tableCaptionSection"), null, null);
        table.setColumnWidth("type", 200);
        table.addContainerProperty("desc", Component.class, null, PbPortlet.getCurrent().messages.getString("tableCaptionDescription"), null, null);
        ...
        table.addContainerProperty("actions", TableExecButtonBar.class, null, PbPortlet.getCurrent().messages.getString("tableCaptionActions"), null, null);
    ...
    public void refreshTable() {
        try {
            ...
            for (DLFileEntry fileEntry : docUtil.getProcessFiles(processUUID)) {
                DocumentLibraryFile dlf = new DocumentLibraryFile(fileEntry.getFileEntryId(),
                        fileEntry.getTitle(), null, fileEntry.getDescription(), null, false);
                ...
                if (delete) {
                    tebb.addButton(new TableLinkButton(PbPortlet.getCurrent().messages.getString("btnDelete"), "icons/cancel.png", dlf, this, Constants.ACTION_DELETE));
                }
                tebb.addButton(new TableLinkButton(PbPortlet.getCurrent().messages.getString("btnOpen"), "icons/document.png", dlf, this, Constants.ACTION_OPEN));
            ...
            if (execBtn.getAction().equals(Constants.ACTION_DELETE)) {
                ...
                try {
                    ...
                    if (dlf.isTemp()) {
                        ...
                        b = docUtil.getFileBody(processUUID, dlf.getId());
                    }
        ...
        try {
            ...
            for (Object object : table.getItemIds()) {
                ...
                if (dlf.isTemp()) {
                    ...
                    docUtil.addFile(processUUID, dlf.getName(), dlf.getDescription(), dlf.getFile(), new String[]{});
                } else {
